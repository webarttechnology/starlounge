...
function post_type_ourrecipe() {

$labels = array(
'name' => _x('OurRecipes', 'plural'),
'singular_name' => _x('OurRecipe', 'singular'),
'menu_name' => _x('OurRecipes', 'admin menu'),
'name_admin_bar' => _x('OurRecipe', 'admin bar'),
'add_new' => _x('Add New', 'add new'),
'add_new_item' => __('Add New OurRecipe'),
'new_item' => __('New OurRecipe'),
'edit_item' => __('Edit OurRecipe'),
'view_item' => __('View OurRecipe'),
'all_items' => __('All OurRecipes'),
...
'public' => true,
'query_var' => true,
'rewrite' => array('slug' => 'ourrecipe'),
'has_archive' => true,
'hierarchical' => false,
);
register_post_type('ourrecipe', $args);
}
add_action('init', 'post_type_ourrecipe');
...
$labels = array(
'name' => _x('Menus', 'plural'),
'singular_name' => _x('Menu', 'singular'),
'menu_name' => _x('Menus', 'admin menu'),
...
add_action('init', 'post_type_menu');
